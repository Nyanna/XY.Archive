...
| **V — Pharmakologisch** | Dopaminerge Upstream-Stabilisierung (MPH/LDX) $\rightarrow$ Migränefreiheit, Bestätigung der D2-Hypersensitivität. |
...
| [05 — Manifestation II: Autonome Dysregulation](05_manifestation2.md) | NTS-Pfade, vestibuloautonomer Reflex, TCR, PFC$\rightarrow$NTS-Suppression, B7-Aphasie. Tonischer NTS-5-HT2A$\rightarrow$RVLM-Pfad, NTS-Tonusinsuffizienz, LDX-Exposition, Nullphase als SWS-Indikator. |
...
| [E — CSD und Epilepsie](0E_epilepsie.md) | Fallback-Hierarchie Raphe $\rightarrow$ CSD $\rightarrow$ Anfall, Serotonin als Antikonvulsivum, SUDEP.                                                                                                                                                                                                                                                                                         |
...
| [J — ME/CFS](0J_mecfs.md) | Dekompensierte Endstrecke der Modellarchitektur, Clearance-Defizit als Integrationsachse, Crash-Bifurkation, SUDEP-Äquivalent, Dual-Hit B2/LPC-DHA.                                                                                                                                                                                                                     |
| [K — Externe Literaturkonvergenz](0K_external_validation.md) | Bilanz der externen Stützung jedes Glieds der modellinternen Kausalkette: DRN$\rightarrow$CSD (Cui 2013), prodromale Bildgebung (Maniyar 2014, Schulte & May), hypothalamisch-trigeminothalamische Anatomie (May & Burstein 2019), zentral wirksame H1-Prophylaxe (Cinnarizin, Cyproheptadin, TCA-H1), Friedman 2016 als wrong-stage-Disconfirmation, thalamokortikale Dysrhythmie. |
| [L — Standortbestimmung](0L_inhabitation.md) | Phasenübergang von Modellbau zu Modellbewohnen; Mortalität als falsches Endpunktmaß; kalibrierte Innenwahrnehmung als eigenständiger Erkenntnisertrag. |
| [M — Metabolische Hirnstamm-Eskalation](0M_metabolical_brainstem_escalation.md) | Schwellenasymmetrische Generatoren (CSD vs. Hirnstamm); zellulärer Pumpen-Loop als Erklärung für Ruhe-Refraktärität; SUDEP-Loop als abgemilderte ANS-Variante; Z3-Hexanal als chemischer Zwei-Hit; O₂-Diskriminationslogik. |
