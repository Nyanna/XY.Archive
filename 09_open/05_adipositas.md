# Notiz: Adipositas-Korrelation mit Modellaspekten

*Status: Explorative Notiz zur späteren Evaluierung — kein Modellbestandteil*
*Datum: 2026-04-04*
...
- **Cortese et al. 2016** (Meta-Analyse, 42 Studien, n=728.136): ADHS↔Adipositas OR 1,20 (Kinder), 1,55 (Erwachsene). Adipositasprävalenz bei ADHS-Erwachsenen ~70% erhöht (28,2% vs. 16,4%).
- **Nigg et al. 2016** (Meta-Analyse, 43 Studien, n=703.937): OR 1,22 gesamt; signifikant bei Frauen (1,19), nicht bei Männern (1,10); stärker bei Erwachsenen (1,37) als Kindern (1,13).
- **Genetische Korrelation**: rg = 0,26–0,30 (GWAS / Zwillingsstudien).
- **Stimulanzien-Effekt**: Assoziation verschwindet in Subgruppe mit Stimulanzienmedikation (Cortese et al. 2016, n=12 Studien).
...
Bei instabiler Raphe-Oszillation (Hit 1) sind beide Pfade phasenweise unter- und überschießend moduliert. Kein linearer Zusammenhang, sondern populations- und phasenabhängig.

### 2.3 Stimulanzien-Gegenprobe
...
**Testbare Differenzierung**: LDX sollte Mahlzeitenstruktur normalisieren (Regelmäßigkeit, Portionsgröße), nicht nur Gesamtkalorienzufuhr senken. Qualitativ anderer Gewichtseffekt als unter reiner Appetitsuppression (z.B. Phentermin).

## 3. Modellspezifische Vorhersage: Population A > B
...
*Quellen: Cortese et al. 2016 (Am J Psychiatry); Nigg et al. 2016 (Clin Psychol Rev); He et al. 2021 (Mol Psychiatry); van Gestel et al. 2021 (Obes Rev / PMC8243944)*