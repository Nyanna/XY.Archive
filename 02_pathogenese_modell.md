...
| Kapitel | Inhalt |
| :------ | :----- |
| **2** | Primärdefekt: Kongenitale Raphe-Dysregulation. Anatomie und Funktion der Raphe-Kerne (2.1), Autoregulationsschleife als Oszillator (2.2), genetische und entwicklungsbiologische Ätiologie (2.3), Dopamin-Serotonin-Interaktion (2.4): Blickrichtungsnystagmus als Biomarker der Dopamin-Hypersensitivität inkl. TAAR1-Modulation (2.4.1), D2High-Shift als Spätfolge frühkindlicher GC-Exposition und Two-Hit-Architektur inkl. epidemiologische Stützung (2.4.2), Verhaltensphänotyp als Vorhersage aus D2High-sensitiver Raphe (2.4.3). Zyklische Desynchronisation: B7/B8-Oszillator und zirkadiane Modulation (2.5): Dual-Oszillator-Architektur (2.5.1), SCN-Raphe-Kopplung und Flaschenhals-Mechanismus (2.5.2), autonomes Mitschwingen (2.5.3), kortikale Wachhaltefunktion der Raphe und lokaler Schlaf (2.5.4), Schlafarchitektur als kortikaler Kohärenzmarker (2.5.5), Evidenz und Einordnung (2.5.6). |
| **3** | Downstream-Pathologie I: Thalamische Fehlkalibrierung. Serotonin als fetales Kalibrierungssignal (3.1), Kalibrierungsmechanismus (3.2), Predictive Coding und verrauschter Referenzwert (3.3), Signal-Rausch-Verhältnis und thalamischer Gain (3.4): Gating/Schwelle-Dissoziation (3.4.1), subkortikales Rauschen als unbewusste kortikale Last (3.4.2), ADHS als SNR-Problem — Diskriminierbarkeit statt Aufmerksamkeitsdefizit (3.4.3), Messbarkeitshypothese (3.4.4), Literaturstütze (3.4.5). |
| **4** | Klinische Manifestation I: Migräne als Raphe-Zyklusstörung. Serotonin als universeller Migräneauslöser inkl. Dreifach-Dissoziation der Kopfschmerzraten unter ADHS-Medikation (4.1), Migränezyklus als Oszillationsphänomen (4.2), Schlaf-Wach-Übergang und kortikale Desynchronisation als Triggermechanismus inkl. Nap-Kaskade und trigeminale Sensitisierung (4.3), CSD-Auslösemechanismus: tonische Destabilisierungswelle als Primärmechanismus, drei Aura-Phänotypen aus Phasenoffset-Topologie (4.4), CSD als kompensatorische Resynchronisation, Betablocker-Paradox, differentielle Pharmakodynamik und zyklische Akkumulation im 6–7-Tage-Rhythmus (4.5). |
