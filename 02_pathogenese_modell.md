...
| Kapitel | Inhalt |
| :------ | :----- |
| **2** | **Primärdefekt: Kongenitale Raphe-Dysregulation.** Anatomie und Funktion der Raphe-Kerne, Autoregulationsschleife als underdämpfter Oszillator, genetische und entwicklungsbiologische Ätiologie. Dopamin-Serotonin-Interaktion als Upstream-Mechanismus: Blickrichtungsnystagmus als Biomarker, D2High-Shift durch frühkindliche GC-Exposition (Two-Hit-Architektur), Verhaltensphänotyp als Vorhersage. Zyklische Desynchronisation: B7/B8-Dual-Oszillator, SCN-Raphe-Kopplung über serielles Relay (MRN als Flaschenhals), autonomes Mitschwingen. Kortikale Wachhaltefunktion der Raphe: lokaler Schlaf als Off-State-Intrusion, posteriore Vulnerabilität durch frontalen Aufwachgradienten, modalitätsspezifische Asymmetrie der Off-State-Last, Tagesprofil als Raphe-Tonus-Proxy und Chronotyp-Fehlattribution. Schlafarchitektur als kortikaler Kohärenzmarker. |
| **3** | **Downstream-Pathologie I: Thalamische Fehlkalibrierung.** Serotonin als fetales Kalibrierungssignal, Kalibrierung auf Signalvarianz statt Mittelwert. Predictive Coding mit verrauschtem Referenzwert: breitere Attraktorbecken, flachere Energielandschaft, begünstigte Assoziation, instabile Routinen. Signal-Rausch-Verhältnis und thalamischer Gain: Gating/Schwelle-Dissoziation unter LDX, subkortikales Rauschen als unbewusste kortikale Last, ADHS als SNR-Problem (Diskriminierbarkeit statt Aufmerksamkeitsdefizit), Messbarkeitshypothese. |
| **4** | **Klinische Manifestation I: Migräne als Raphe-Zyklusstörung.** Serotonin als universeller Migräneauslöser, Dreifach-Dissoziation der Kopfschmerzraten unter ADHS-Medikation. Migränezyklus als Oszillationsphänomen. Schlaf-Wach-Übergang als Triggermechanismus: Nap-Kaskade, trigeminale Sensitisierung, LDX-Beobachtung. CSD-Auslösemechanismus: tonische Destabilisierungswelle, Intratakt-Fragmentierung als vesikuläre Auflösungsgrenze, drei Aura-Phänotypen, metabolische Krise mit Pre- und Post-CSD-Kausalrichtung. CSD als kompensatorische Resynchronisation: Betablocker-Paradox, differentielle Pharmakodynamik Metoprolol vs. LDX, zyklische Akkumulation im 6–7-Tage-Rhythmus. MBA-Reattribution: ANS-Kollaps durch Raphe-Proximität statt Brainstem-CSD. Zwei-Oszillator-CSD-Bedingung: Differentialphänotypologie aus B7/B8-Zustand, LDX-Effekt auf CSD-Fenster. Sport als Migränetrigger: B7-Depletion durch sympathischen Maximaltakt. Sumatriptan-Mechanismus: Schmerzblockade als Schlaf-Enabler, SCN-vermittelte Resynchronisation, dreigliederige Triptan-Wirkung. |
...
| **8** | **Interozeptive Inkohärenz als Downstream-Effekt monoaminerger Desynchronisierung.** Fünf aufsteigende Modulationssysteme als asynchrone Zustandsparameter-Setzer, Insula ohne kohärenten Prediction Error. Phänomenologie: Zustandsblindheit, retikulärer Tonus. Dopaminerge Synchronisierung als Auflösung: LDX-Kohärenz vs. Arousal, Interozeption als neues Erleben, Schlafkonsolidierung als quantitative Evidenz. Reformulierung des ADHS-Kerndefizits: Konzentration als Fehlattribution, NREM-Parasomnien als extremste State-Dissoziation. Kreuzkorrelation ADHD–Migräne–Epilepsie–Late-Chronotyp. |
...
**Ein Mechanismus, ein Defekt, zwei Downstream-Effekte.** Die Zwei-Prozess-Darstellung (Intra-Kern-Oszillation vs. Inter-Kern-Versatz, vgl. D.4.3) ist phänomenologisch korrekt — beide Phänomene existieren und sind messbar —, aber mechanistisch redundant. Der MRN-5-HT1A-Autorezeptor ist der anatomische und funktionelle Flaschenhals, der beide Effekte erzeugt.
...
#### **2.5.3 Autonomes Mitschwingen: Zirkadiane Amplifikation des Grundrhythmus**
...
Die Schlafarchitektur (detailliert in Anhang B) ist ein direkter Ausdruck der in 2.5.1–2.5.4 beschriebenen Mechanismen und verbindet die Oszillator-Ebene mit messbarer kortikaler Kohärenz.
...
#### **4.4.2 Depolarisationswelle: Mechanismus und Produkte**
...
#### **E.1.2 Mechanismus: 5-HT → GABAerge Interneuronen → kortikale Inhibition**
...
#### **E.2.3 Trigger-Mechanismus: Extrazelluläres Kalium**
...
#### **E.4.1 Uminterpretation der CGRP-Funktion**
...
#### **E.4.2 CGRP-Anstieg nach epileptischen Anfällen — Residuum des gescheiterten CSD-Versuchs**
...
#### **E.6.1 Reset-Versagen auf allen Stufen**
...
#### **E.6.2 Propofol-Narkose als erzwungener Reset: Evidenz**
...
#### **E.6.3 Therapeutische Implikation**
...
#### **E.7.1 Epidemiologische Evidenz**
...
#### **E.7.2 Modellinterpretation: Kortikale Hypererregbarkeit als gemeinsame Basis**
...
Im Wachzustand hat das System drei Kompensatoren, die Exzitation kortikal halten: PFC-top-down-Kontrolle (Anhang D.5.3), aufgabengetriebener exogener Arousal-Drive (vgl. 2.5.4), und bewusste Handlungsfähigkeit. Alle drei fallen im Schlaf weg. Gleichzeitig konvergieren alle Vulnerabilitäten:
...
#### **E.7.5 Topiramat-Signal: Substanzspezifische SUDEP-Risikoerhöhung**
...
#### **E.7.6 FAERS-Disproportionalitätsanalyse: Methodischer Vorschlag**
...
#### **E.7.7 SUDEP-Interventionsprotokoll: Mechanische Perfusion bei reversiblem Brainstem-SD**

##### **E.7.7.1 Evidenzbasis: Brainstem-SD ist reversibel**
...
##### **E.7.7.2 Warum konventionelle Reanimation versagt**
...
##### **E.7.7.3 Partieller Grundtonus als Erholungsschwelle**
...
##### **E.7.7.4 Vorgeschlagenes Protokoll: Sequentielle Dual-Strategie**
...
##### **E.7.7.5 Rechtlicher Rahmen: Patientenverfügung als Opt-in**
...
- Kapitel 2.5 (Primärdefekt): Suboptimale T3-Versorgung verstärkt den Primärdefekt durch Aufrechterhaltung der 5-HT1A-Autorezeptorsensitivität.
- Kapitel 7 (Therapie): T4-Substitutionsadäquanz als unerkannter Modulator der LDX-Wirksamkeit.
- Anhang G (Iatrogene Prävalenz): Autoimmunthyreoiditis als zusätzliche Downstream-Manifestation der immunmodulatorischen Dysregulation.
...
#### H.4.1 TSH-Insuffizienz als Marker
