# Forschungsprogramm: Alginat-Bead-Retardierung von Lisdexamfetamin

## Zielsetzung

Entwicklung einer individualisierten Retardformulierung für Lisdexamfetamin (LDX) auf Basis von Calciumalginat-Beads, mit dem Ziel einer Verlängerung der Wirkdauer von ~14h auf ~19h und einer Reduktion der täglichen Spiegeldynamik im Steady-State.

## Pharmakologische Rationale

LDX ist bereits ein Prodrug mit eingebauter Retardierung: Die enzymatische Spaltung in den Erythrozyten zu D-Amphetamin ist der Rate-Limiting-Step. Durch eine zusätzliche verzögerte gastrointestinale Freisetzung wird ein zweiter Rate-Limiting-Step vorgeschaltet, der den Absorptionspeak abflacht und den Wirkungstail verlängert.

Bei täglicher Einnahme im Steady-State führt die Verlängerung von 14h auf 19h Wirkdauer zu einer fundamentalen Änderung der Tageskinetik: Die wirkungsfreie Lücke verkürzt sich von ~10h auf ~5h, wodurch sich ein erhöhter Basisspiegel aufbaut und die Peak-Tal-Amplitude schrumpft. Die tägliche AUC bleibt konstant (identische Dosis), aber die Verteilung über 24h wird gleichmäßiger.

Dieser quasi-konstante Spiegel ist therapeutisch überlegen gegenüber der hohen Dynamik der Standard-Formulierung, insbesondere bei D2-Rezeptor-Supersensitivität, wo der tägliche Crash vom therapeutischen Spiegel auf Null selbst einen dopaminergen Rebound-Stressor darstellt.

Ein weiterer Vorteil der Bead-Formulierung: Im Steady-State dominiert nicht mehr die Pharmakokinetik des Medikaments die Tageskurve, sondern die individuelle Physiologie – Magenentleerung, Dünndarm-Motilität, Leberdurchblutung. Bei stabilem Tagesrhythmus (gleiches Frühstück, gleiche Uhrzeit) wird das Essverhalten selbst zur reproduzierbaren Retardformulierung. Körperliche Aktivität erhöht die Leberdurchblutung und damit den Abbau, Ruhe verlangsamt ihn – eine natürliche, bedarfsgesteuerte Modulation.

## Gastrointestinale Parameter

- **Magenverweildauer:** 1–4h (nüchtern kürzer, nach Mahlzeit länger)
- **Magen-pH:** 1–3 (Alginat relativ stabil, minimale Erosion)
- **Dünndarm-Transitzeit:** 3–5h (Hauptabsorptionsort für LDX)
...
Fünf aufeinanderfolgende Versuchstage, jeweils mit identischem Tagesrhythmus (gleiche Aufstehzeit, gleiches Frühstück, gleiche Uhrzeit der Einnahme):
...
Für jeden Tag dokumentieren:

- Uhrzeit der Einnahme
- Mahlzeit (Art, Menge, Zeitpunkt)
- Subjektiver Effekt: Onset (Zeitpunkt der ersten spürbaren Wirkung)
- Subjektiver Effekt: Peak (Zeitpunkt der stärksten Wirkung)
- Subjektiver Effekt: Offset (Zeitpunkt des Abklingens)
- Gesamte wahrgenommene Wirkdauer
- Urin-pH (mit Teststreifen, optional)
- Qualitative Beschreibung (Wachheit, Fokus, Stimmung, Schlafqualität der Folgenacht)
...
Basierend auf Phase-2-Ergebnissen Stellschrauben anpassen:
...
Jede Parameteränderung als separate Versuchsreihe dokumentieren mit denselben Erfassungsparametern wie in Phase 2.

## Phase 4: Übertragung auf LDX

Erst nach validiertem Taurin-Profil, das eine Wirkdauer von >10h mit gleichmäßigem subjektivem Effekt zeigt.
...
- Subjektiver Effekt über 24h dokumentieren (stündliche Selbsteinschätzung)
- Schlafqualität der Folgenacht
- Migräne-Protokoll parallel führen
- Optional: Speichel-Selbsttest zu verschiedenen Zeitpunkten (AMP 50 ng/ml)
...
### Regulatorisch
Die Einnahme des eigenen verschriebenen Medikaments in modifizierter Darreichungsform ist rechtlich nicht reguliert. Die Fachinformation erlaubt ausdrücklich das Öffnen der Kapsel und Einmischen in Nahrung. Eine Alginat-Matrix fällt unter „Nahrung" (E401 ist ein Lebensmittelzusatz). Es gibt keine erkennbare rechtliche Grauzone, solange die Gesamtdosis der Verschreibung entspricht.

## Ausblick

Bei erfolgreichem Proof-of-Concept mit konstantem 19h-Profil und dokumentierter Steady-State-Stabilisierung:

- Integration der Bead-Kinetik in das bestehende Pathogenesemodell (02_pathogenese_modell.md)
- Dokumentation als Anhang zum Migräneprotokoll
- Potenzielle Evidenz für Facharztvorstellung: empirisch optimierte Dosierform als Nachweis informierter, verantwortungsvoller Medikationsführung