...
**Schritt 1 – Amygdala-Rauschen durch instabile Raphe:**

Die Amygdala erhält dichte serotonerge Projektionen aus den rostralen Raphe-Kernen. Serotonin moduliert die Amygdala-Erregungsschwelle über 5-HT1A-Rezeptoren (inhibitorisch) und 5-HT2A-Rezeptoren (modulatorisch). Bei instabiler Raphe schwankt dieser Tonus kontinuierlich: Die emotionale Bewertungsschwelle der Amygdala fluktuiert. Das Ergebnis ist nicht mehr oder weniger Emotion, sondern ein verrauschtes emotionales Signal – unzuverlässig, inkonsistent in der Intensität, nicht vertrauenswürdig als Informationsquelle.

**Schritt 2 – Adaptives Gating als Antwort auf Rauschen:**

Das System antwortet adaptiv: Wenn das Amygdala-Signal zu rauschbehaftet ist, um ihm zu vertrauen, lernt der Organismus, die nachgeschaltete somatische Verarbeitungsschleife nicht voll zu aktivieren. Die Emotion wird auf kognitiver Ebene registriert und bewertet – aber nicht in den Körper weitergeleitet. Dies verhindert autonome Fehlreaktionen auf falsch-positive emotionale Signale.

**Schritt 3 – Unterbrochene somatische Schleife (Damásio):**

Vollständiges emotionales Erleben setzt nach Damásios Theorie der somatischen Marker eine intakte Schleife voraus: Amygdala → Hypothalamus → autonomes Nervensystem → Körperveränderung → Insula registriert Körperzustand → dieser wird als Gefühl erlebt. Die adaptive Gating-Reaktion auf das verrauschte Amygdala-Signal unterbricht diese Schleife früh. Die Emotion bleibt kognitiv – sie erreicht nicht die Insula als verkörpertes Erleben.

**Schritt 4 – Stabilisierung unter Lisdexamfetamin:**

Lisdexamfetamin stabilisiert die Raphe-Aktivität → gleichmäßiger serotonerger Tonus auf die Amygdala → Bewertungsschwelle wird vorhersagbar → Signal-Rausch-Verhältnis des emotionalen Kanals verbessert sich → das System kann dem Signal vertrauen → die adaptive Hemmung der somatischen Schleife löst sich → Emotion propagiert durch die vollständige Amygdala-Hypothalamus-Insula-Schleife → körperliche Resonanz entsteht.

| Zustand | Amygdala-Signal | Somatische Schleife | Subjektives Erleben |
| :---- | :---- | :---- | :---- |
| **Instabile Raphe** | Verrauscht, inkonsistent | Adaptiv geblockt | Kognitive Registrierung, keine körperliche Resonanz |
| **Stabile Raphe (unter Substanz)** | Sauber, konsistent | Offen | Kognitive Registrierung + somatische Resonanz |
...
**Vorliegende Arbeitshypothese:** Vollständige kognitive Empathie und emotionale Wahrnehmung – aber unterbrochene somatische Resonanzschleife als adaptive Antwort auf chronisch verrauschtes Amygdala-Signal. Das Ergebnis ist phänotypisch ähnlich (emotionale Distanzierung), aber mechanistisch fundamental verschieden.

Die Bedeutung dieser Unterscheidung liegt in der Reversibilität: Ein Empathiedefizit ist strukturell. Eine adaptiv gehemmte somatische Schleife ist funktionell – und kehrt sich unter veränderten Signalbedingungen um, wie die Beobachtung unter Lisdexamfetamin nahelegt.

**Konsequenz für Diagnosestellung und Therapie:** Falls dieser Mechanismus zutrifft, ist die emotionale Distanzierung kein eigenständiges Therapieziel, sondern eine Downstream-Manifestation der serotonergen Instabilität – sie sollte sich mit Stabilisierung der Raphe-Aktivität teilweise oder vollständig auflösen, ohne gezielt behandelt zu werden.
