# Hypothetische Leitlinie zur Titrationsmethodik von Stimulanzien bei ADHS
...
### 1.3 Asymmetrie der Kurvenformen

Die klassische invertierte U-Kurve (Arnsten/Goldman-Rakic) ist für ADHS-Betroffene nicht identisch mit der neurotypischen Kurve. Es handelt sich nicht um eine bloße Linksverschiebung, sondern um eine qualitativ andere Kennlinie:
...
Symptombasierte Titration (Fremd- und Selbstrating, z. B. ADHD-RS, CGI) ist:
...
Jugendliche berichten konsistent, sich unter Medikation *nicht mehr wie sie selbst* zu fühlen. Dies ist kein Complianceproblem, sondern ein Hinweis auf pharmakologische Überschreitung der organischen Basislinie. Bei langjähriger Behandlung in der Entwicklungsphase:

- Identitätsformation auf artifiziellem Zustand statt organischer Kennlinie
...
## 4. Substanzspezifische Hinweise

### 4.1 Methylphenidat (MPH)
...
- Das Minimax-Argument trägt ohne neue Daten
